...
namespace XNodeEditor {
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node> {
        ...
        public virtual void OnHeaderGUI() {
			...
			{
				s += (target as DialogNode).dialogID;
			}
            GUILayout.Label(s, NodeEditorResources.styles.nodeHeader, GUILayout.Height(30));
        }
        ...
        public virtual void OnBodyGUI() {
			...
			List<string> excludes = target.GetExclusions();
			excludes.Add("m_Script");
			excludes.Add("graph");
			excludes.Add("position");
			excludes.Add("ports");
		...
		public virtual void OnNodeGUI(int i)
		{
			...
			if (target is DialogNode)
			{
				excludes = (target as DialogNode).GetExclusions(i);
			}
			else
			{
